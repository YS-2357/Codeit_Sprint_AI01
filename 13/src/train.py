...
from src.uitils import get_predictions_and_labels, print_acc_and_confusion_matrix, print_samples, check_trainable_parameters
...
def run_train_and_eval(data_config: dict, trainer_config: dict, module_config=None):
    ...
    """
    # 데이터 준비
    df = get_df(data_config["data_dir"], data_config["task_type"])
